...
class Funcionario(Usuario):
    ...
    def cadastrar_cliente(usuario, senha, cpf, primeiro_nome, sobrenome):
        conexao = conectar_banco()
        try:
            cursor = conexao.cursor()
            ...
            VALUES (%s, %s)
            """
            cursor.execute(query_cliente, (usuario_id, 0))
            conexao.commit()
    ...
    def editar_cliente(id, usuario=None, senha=None, cpf=None, primeiroNome=None, sobrenome=None):
        conexao = conectar_banco()
        try:
            cursor = conexao.cursor()
...
class Emprestimo:
    ...
    def realizar_emprestimo(id_cliente, id_livro, id_funcionario):
        ...
        try:
            ...
            query_atualizar_quantidade = "UPDATE cliente SET emprestimos = emprestimos + 1 WHERE id = %s"
            cursor.execute(query_atualizar_quantidade, (id_cliente,))
